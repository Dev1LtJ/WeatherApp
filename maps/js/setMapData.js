...
let mapContainer = document.querySelector('.primary__map');

export async function setMapData() {
    //setCity(titleCity);
    let requestURL = `https://api.weather.yandex.ru/v2/forecast?lat=53.90249633789063&lon=27.56148147583008&lang=ru_RU&limit=7&hourse=true&extra=true`;
